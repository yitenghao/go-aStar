...
func TestInitBackground(t *testing.T) {
	...
	b.Move([]image.Point{{1, 1}, {0, 0}}, color.RGBA{255, 0, 0, 255}) // upLeft
	b.Move([]image.Point{{1, 1}, {0, 2}}, color.RGBA{255, 0, 0, 255}) // downLeft
	b.Move([]image.Point{{1, 1}, {2, 2}}, color.RGBA{255, 0, 0, 255}) // downRight
	b.Move([]image.Point{{1, 1}, {2, 0}}, color.RGBA{255, 0, 0, 255}) // upright
